...
public enum RepairableItems {
    ...
    @SerializedName("NetheriteHelmet")
    NETHERITE_HELMET(Material.NETHERITE_HELMET, Material.NETHERITE_INGOT),
    @SerializedName("NetheriteChestplate")
    NETHERITE_CHESTPLATE(Material.NETHERITE_CHESTPLATE, Material.NETHERITE_INGOT),
    @SerializedName("NetheriteLeggings")
    NETHERITE_LEGGINGS(Material.NETHERITE_LEGGINGS, Material.NETHERITE_INGOT),
    @SerializedName("NetheriteBoots")
    NETHERITE_BOOTS(Material.NETHERITE_BOOTS, Material.NETHERITE_INGOT),
    ...
    @SerializedName("NetheriteSword")
    NETHERITE_SWORD(Material.NETHERITE_SWORD, Material.NETHERITE_INGOT),
    @SerializedName("NetheritePickaxe")
    NETHERITE_PICKAXE(Material.NETHERITE_PICKAXE, Material.NETHERITE_INGOT),
    @SerializedName("NetheriteAxe")
    NETHERITE_AXE(Material.NETHERITE_AXE, Material.NETHERITE_INGOT),
    @SerializedName("NetheriteShovel")
    NETHERITE_SHOVEL(Material.NETHERITE_SHOVEL, Material.NETHERITE_INGOT),
    @SerializedName("NetheriteHoe")
    NETHERITE_HOE(Material.NETHERITE_HOE, Material.NETHERITE_INGOT),
    ;
