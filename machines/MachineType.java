...
public enum MachineType {
    ...
    CARGO(45, new int[]{20}, new int[]{13, 14, 15, 16, 22, 23, 24, 25, 31, 32, 33, 34}, 13, 14, 15, 16, 22, 23, 24, 25, 31, 32, 33, 34);

    private final int size;
    private final int[] clickableSlots, inputOrNetwork, outputOrWhitelist;
    MachineType(int size, int[] inputOrNetwork, int[] outputOrWhitelist, int... clickableSlots) {
        this.size = size;
        this.clickableSlots = clickableSlots;
        this.inputOrNetwork = inputOrNetwork;
    ...
    /**
     * @return network slot if cargo, input slots otherwise
     */
    public int[] getInputOrNetwork() {
        return this.inputOrNetwork;
    }
