...
public class Facilitator extends MachineRecipe {
    ...
    public List<ItemStack[]> validInputs() {
        ...
        input.add(new ItemStack[]{IngredientList.BAUXITE.getItem(), IngredientList.SODIUM_HYDROXIDE.getItem(2)});
    ...
    public List<ItemStack[]> validOutputs() {
        ...
        output.add(new ItemStack[]{IngredientList.GIBBSITE.getItem()});
